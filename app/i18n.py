...
STRINGS: dict[str, dict[str, str]] = {
    ...
    'app.also_in_hint': {"it": 'La stessa app è pubblicata in più repository. spritz non sceglie per te: qui sotto le fonti, scegli quella che preferisci.', "es": 'La misma app está publicada en varios repositorios. spritz no elige por ti: aquí están las fuentes, elige la que prefieras.', "de": 'Dieselbe App ist in mehreren Repositorys veröffentlicht. spritz wählt nicht für dich: hier die Quellen, wähle deine bevorzugte.', "zh": '同一应用发布在多个仓库中。spritz 不替你选择：以下是来源，请选择你偏好的。', "nl": 'Dezelfde app staat in meerdere repositories. spritz kiest niet voor je: hieronder de bronnen, kies je voorkeur.', "fr": 'La même app est publiée dans plusieurs dépôts. spritz ne choisit pas à votre place : voici les sources, choisissez la vôtre.', "ja": '同じアプリが複数のリポジトリで公開されています。spritz は選びません。以下の入手先から選んでください。', "vec": "La stessa app xe publicà in pi repository. spritz no sielze par ti: qua soto le fonti, sielzi quea che te piase."},
}
